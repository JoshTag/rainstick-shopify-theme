...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* binding */ Launch_Launch; });

// EXTERNAL MODULE: ./source/scripts/utils/NodelistForeachPolyfill.js
var NodelistForeachPolyfill = __webpack_require__(12);
...
var TemplateAddresses_TemplateAddresses = /*#__PURE__*/function () {
  ...
  _createClass(TemplateAddresses, [{
    ...
    value: function prepareAddresses() {
      ...
      selectableOptions.each(function (index, select) {
...
var BlogPost_BlogPost = /*#__PURE__*/function () {
...
var DynamicImagesWithText_DynamicImagesWithText = /*#__PURE__*/function () {
...
var DynamicTestimonial_DynamicTestimonial = /*#__PURE__*/function () {
...
var StaticAnnouncementBar_AnnouncementBar = /*#__PURE__*/function () {
...
var shopify_asyncview_dist_index_es_createClass = function () {
  function defineProperties(target, props) {
    for (var i = 0; i < props.length; i++) {
      var descriptor = props[i];
      descriptor.enumerable = descriptor.enumerable || false;
...
var StaticGiftCard_StaticGiftCard = /*#__PURE__*/function () {
...
var Goal_Goal = /*#__PURE__*/function () {
...
/* harmony default export */ var ThemeUtils = ({
  ...
  extend: function extend(dest) {
    ...
    objs.forEach(function (obj) {
      result = _objectSpread(_objectSpread({}, result), obj);
    });
    return result;
  },
...
var StaticSlideshow = /*#__PURE__*/function () {
  function StaticSlideshow(_ref) {
    ...
    this.fullWindowHeight = window.innerHeight; // Settings
    ...
    if (this.slideNavigation.length) {
      this._registerEvent(this.slideNavigation[0], 'click', function (e) {
        e.preventDefault();

        _this._previousSlide();
      });

      this._registerEvent(this.slideNavigation[1], 'click', function (e) {
        e.preventDefault();

        _this._nextSlide();
      });

      this._registerEvent(this.slidePagination, 'click', function (e) {
        e.preventDefault();
        var parentNode = e.target.parentNode;

        if (parentNode.classList.contains('pagination-list-item')) {
          _this._specificSlide(parentNode);
        }
      });
    }

    this._registerEvent(this.el, 'mouseenter', function () {
      return _this._pauseLoop();
    });

    this._registerEvent(this.el, 'mouseleave', function () {
      return _this._startLoop();
    });

    this._registerEvent(this.el, 'rimg:load', function () {
      return _this._setActiveSlideHeight();
    });

    this._registerEvent(window, 'resize', function () {
      // This is to prevent resize on scroll of Android and iOS when the address bar is hidden.
      if (window.innerWidth === _this.fullWindowWidth) return;
      _this.fullWindowWidth = window.innerWidth;
      _this.fullWindowHeight = window.innerHeight;

      _this._setActiveSlideHeight();
    }); // Initializers
  ...
  StaticSlideshow_createClass(StaticSlideshow, [{
    ...
    key: "_setActiveSlideHeight",
    value: function _setActiveSlideHeight() {
      var slideText = this.activeSlide.querySelector('.slide-text');
      var slideImage = this.activeSlide.querySelector('.slide-image');
      var slidePadding = this.slidePagination ? this.slidePagination.getBoundingClientRect().height * 2 : 60;
      var textHeight = slideText ? slideText.getBoundingClientRect().height + slidePadding : 0;
      var imageHeight = slideImage.getBoundingClientRect().height;
      if (!imageHeight) return;
      var slideHeight;

      if (this.slideshowLayout === 'full-window') {
        var headerHeight = this.headerNavigation.getBoundingClientRect().height; // If there is too much text, the height of the slide should be more than the full
        ...
        var announcementBarEl = document.querySelector('.pxs-announcement-bar'); // If is full window, subtract announcement bar height

        if (announcementBarEl) {
          slideHeight -= announcementBarEl.getBoundingClientRect().height;
        }

        this.slideshowWrapper.style.height = "".concat(slideHeight, "px"); // Update height of all slides since they should all be the same height.
        // This is to ensure all lazy loading of images crop the same.

        for (var i = 0; i < this.slides.length; i++) {
          this.slides[i].style.height = "".concat(slideHeight, "px");
        }
      } else {
        // Minimum height is height of text, or image, which ever is larger
        slideHeight = Math.max(textHeight, imageHeight);
        this.slideshowWrapper.style.height = "".concat(slideHeight, "px");
        this.activeSlide.style.height = "".concat(slideHeight, "px");
      }
    }
  }, {
    key: "_setSlideshowClasses",
    value: function _setSlideshowClasses() {
      var slideTextStyle = this.activeSlide.getAttribute('data-slide-text');
      document.body.classList.remove('slide-color-light');
      document.body.classList.remove('slide-color-dark');
      document.body.classList.add("slide-color-".concat(slideTextStyle));
    }
  }, {
    key: "_specificSlide",
    value: function _specificSlide(target) {
      if (this.sliding) return;

      if (!target.classList.contains('active')) {
        var nextSlideID = target.getAttribute('data-slide-id');
    ...
    key: "_getIndexOfSlide",
    value: function _getIndexOfSlide(slide) {
      for (var i = 0; i < this.slides.length; i++) {
    ...
    key: "_showNewSlide",
    value: function _showNewSlide(type, specificSlideID) {
      var _this2 = this;
      ...
      var activeSlideIndex = this._getIndexOfSlide(this.activeSlide);

      if (specificSlideID) {
        this.nextSlide = this.el.querySelector("#".concat(specificSlideID));
      } else if (type === 'next') {
      ...
      this._slideListener = this._registerEvent(this.nextSlide, 'transitionend', function () {
        return _this2._slideTransitionEnd();
      }).listener;
    ...
    key: "_slideTransitionEnd",
    value: function _slideTransitionEnd() {
    ...
    key: "_updateSlidePagination",
    value: function _updateSlidePagination() {
      var index = this._getIndexOfSlide(this.activeSlide);
    ...
    key: "_lockSlide",
    value: function _lockSlide(slideID) {
    ...
    key: "onSectionUnload",
    value: function onSectionUnload() {
      this.events.forEach(function (_ref2) {
        var el = _ref2.el,
            event = _ref2.event,
    ...
    key: "_registerEvent",
    value: function _registerEvent(el, event, listener) {
      this.events.push({
        el: el,
        event: event,
        listener: listener
    ...
    value: function _unregisterEvent(el, event, listener) {
      this.events = this.events.filter(function (e) {
        return el !== e.el || event !== e.event || listener !== e.listener;
      });
      el.removeEventListener(event, listener);
...
var GoogleMap_GoogleMap = /*#__PURE__*/function () {
...
var flickity_fade = __webpack_require__(25);
...
var ProductGallery_ProductGallery = /*#__PURE__*/function () {
  function ProductGallery(el, settings) {
    ...
    if (this.navigation) {
      ...
      this.onNavigationArrowClick = function (e) {
        var direction = e.target.dataset.slideshowMovement;

        if (direction === 'next') {
          _this.flickity.next(true);
        } else {
          _this.flickity.previous(true);
        }
      };

      this.events.register(this.navigation, 'click', function (event) {
        if ('productGalleryThumbnail' in event.target.dataset) {
          _this.flickity.select(parseInt(event.target.dataset.productGalleryThumbnail, 10));
        }
      });
      this.events.register(this.navigation, 'focusin', function (event) {
        ...
        _this.flickityThumbnails.select(parseInt(event.target.dataset.productGalleryThumbnail, 10));
      });
      this.navigationArrows.forEach(function (arrow) {
        return _this.events.register(arrow, 'click', _this.onNavigationArrowClick);
      });
      cjs["onChange"](function (data) {
        return _this._onBreakpointChange(data);
      });
    }
  ...
  ProductGallery_createClass(ProductGallery, [{
    ...
    value: function _onBreakpointChange(_ref) {
    ...
    value: function _onExternalVideoLibraryLoad() {
      ...
      videoFigures.forEach(function (videoFigure) {
        ...
        player.addEventListener('onStateChange', function (_ref2) {
          var data = _ref2.data;
    ...
    value: function _onMediaSelect(media) {
      ...
      switch (media.type) {
        ...
        case 'model':
          if (document.querySelector('html').classList.contains('no-touch') && cjs["min"]('L')) {
            media.play();
          }
    ...
    value: function _initFlickity() {
      ...
      this.flickity = new js_default.a(this.viewport, flickityGalleryOptions);
      this.flickityThumbnails = new js_default.a(this.navigation, flickityThumbnailOptions);
      this.navScroller = this.flickityThumbnails.element;
      this.flickityEvent = this.events.register(this.viewport, 'rimg:load', function () {
        return _this6.flickity.resize();
      });
      this.flickityThumbnailsEvent = this.events.register(this.navigation, 'rimg:load', function () {
        return _this6.flickityThumbnails.resize();
      });
      this.viewport.querySelectorAll('video').forEach(function (video) {
        return _this6.events.register(video, 'loadeddata', function () {
          if (_this6.flickity) {
            _this6.flickity.resize();
          }
        });
      }); // Ensures models and video auto-play when swiping through the slideshow

      this.flickity.on('change', function (index) {
        _this6._selectMediaByIndex(index);

        if (_this6.flickityThumbnails.selectedIndex !== index) {
          _this6.flickityThumbnails.select(index);
        }
      });
      this.flickity.on('settle', function () {
        _this6.media.filter(function (m) {
      ...
      this.flickity.on('staticClick', function (event, pointer, cellElement) {
        ...
        var figure = cellElement.dataset.mediaType === 'model' ? cellElement : false;

        if (figure) {
          var model = _this6.media.filter(function (item) {
    ...
    key: "_shouldThumbnailsWrap",
    value: function _shouldThumbnailsWrap() {
      // Mobile = 2 arrows + 3 slides
      // Desktop = 2 arrows + 5 slides
      return cjs["max"]('S') ? this.navigation.childElementCount > 5 : this.navigation.childElementCount > 7;
    }
  }, {
...
var ProductDetails_ProductDetails = /*#__PURE__*/function () {
  function ProductDetails(instance) {
    ...
    this.$el.on('submit', '.product-form', function (event) {
  ...
  ProductDetails_createClass(ProductDetails, [{
    ...
    value: function addToCart(e) {
      ...
      if (quantity === '' || quantity === '0') {
        setTimeout(function () {
          _this2.$el.find("input[name='quantity']").addClass('error');

          _this2.$productMessage.text(_this2.productSettings.setQuantityText);

          _this2.$el.find('.add-to-cart').removeClass('loading added-success').addClass('added-error');
        ...
        Shopify.addItemFromForm(this.productForm, function (cartItem) {
          ...
          return setTimeout(function () {
            ...
            var successMessage = _this2.productSettings.successMessage.replace('** product **', "<em>".concat(cartItem.title, "</em>"));

            _this2.$productMessage.html(successMessage);

            _this2.$el.find("input[name='quantity']").removeClass('error');

            _this2.$el.find('.add-to-cart').removeClass('loading added-error').addClass('added-success');

            jquery_default()('.header-cart-count').addClass('active');
            
            Shopify.getCart(function (cart) {
              return jquery_default()('.header-cart-count').text(cart.item_count);
            });

            _this2.$addToCartButton.val('Added to cart');

            _this2.processing = false;
            
            jquery_default()('#add-to-cart-pop-up').addClass('active');
            jquery_default()('#pop-up-message').text(cartItem.title + ' has been added to your cart');
            ...
            function gtag_report_conversion(url) { var callback = function () { if (typeof(url) != 'undefined') { } }; gtag('event', 'conversion', { 'send_to': 'AW-10797305899/9dRXCJy574oDEKugx5wo', 'event_callback': callback }); return false; } 
            gtag_report_conversion('https://rainstickshower.com/products/rainstick-shower');
            
            setTimeout(function(){
              jquery_default()('#add-to-cart-pop-up').removeClass('active');
            }, 5000);
    ...
    value: function handleErrors(errors) {
      ...
      if (errorMessage.message === 'Cart Error') {
        setTimeout(function () {
          ...
          _this3.$productMessage.html(errorDescription);
    ...
    key: "unload",
    value: function unload() {
      this.$el.off('submit', '.product-form').off('click', '.product-tabs-header-item').off('click', '.number-input-nav-item');
...
var fitvids = __webpack_require__(5);
...
var RTE_RTE = /*#__PURE__*/function () {
  ...
  RTE_createClass(RTE, [{
    ...
    value: function setupTabs() {
      this.tabs = new dist_default.a(document.querySelector('.rte'), {
        layout: 'tabs'
      });
    }
  }, {
...
var Select_Select = /*#__PURE__*/function () {
  ...
  Select_createClass(Select, [{
    ...
    value: function updateSelectText() {
      var newOption = this.$el[0].querySelector('option:checked');
      var optionText = newOption ? newOption.innerHTML : '';
...
var Launch_Launch = /*#__PURE__*/function () {
  function Launch() {
    ...
    if (jquery_default()(document.body).hasClass('template-customers-addresses')) {
      new TemplateAddresses_TemplateAddresses({
        el: $body
      });
    }

    if (jquery_default()(document.body).hasClass('template-customers-login')) {
      new TemplateAccount_TemplateAccount({
        el: $body
      });
    }
  }
...
/***/ })
/******/ ]);
//# sourceMappingURL=site.js.map?1591633021864
...
$(document).ready(function() {
    ...
    var flktyWaitlist = new Flickity(carouselWaitlist, {
      cellAlign: 'left',
      wrapAround: true,
      prevNextButtons: false
    });
   ...
   $('#accordion .hide').hide();
   $('#accordion .accordion__title h3').click(function(){
  ...
  $('#faq-questions .dynamic-faq__question').click(function(){
   ...
   $('.button-toggle--left').click(function(){
       ...
       $('#image-compare-text--two').removeClass("active");
       $('#traditional-overlay').removeClass("active");
       $('#image-compare-text--one').addClass("active");
       $('#circular-overlay').addClass("active");
     return false;
   });
   $('.button-toggle--right').click(function(){
       $(this).addClass("active").siblings().removeClass('active');
       $('#image-compare-overlay').removeClass("image-circular").addClass("image-traditional");
       $('#image-compare-text--one').removeClass("active");
       $('#circular-overlay').removeClass("active");
       $('#image-compare-text--two').addClass("active");
   ...
   $("body").on(
    ...
    $('a[href^="#shopify-section-b2b-how-it-works"]').click(function() {
      $([document.documentElement, document.body]).animate({
        scrollTop: $("#shopify-section-b2b-how-it-works").offset({ top: 100 }).top
      }, 1200);
    });
